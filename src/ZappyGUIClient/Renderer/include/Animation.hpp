...
public:
    ...
    Animation(Action action, Vector2 startPos, Vector2 endPos, Texture2D &sheet);
    ...
    static std::unique_ptr<Animation> create(Action a, Vector2 startPos, Vector2 endPos, Texture2D &sheet);
private:
